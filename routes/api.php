...
Route::prefix('alimentos')->group(function () {
    ...
    Route::get('/semaforo',  [AlimentoController::class, 'semaforo']);    // GET /api/alimentos/semaforo
...
Route::prefix('recetas')->group(function () {
    ...
    Route::get('/para-mi',   [RecetaController::class, 'paraMi']);        // GET /api/recetas/para-mi
